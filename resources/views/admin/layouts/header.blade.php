        ...
        <ul class="navbar-nav ml-auto">
          ...
          <li class="dropdown nav-item">
            <a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
              <div class="photo">
                <img src="{{url('admin/assets/img/anime3.png')}}" alt="Profile Photo">
              </div>
            ...
            <ul class="dropdown-menu dropdown-navbar">
              ...
              <li class="nav-link"><a href="{{url('admin/edit/password')}}" class="nav-item dropdown-item">Update Password</a></li>
